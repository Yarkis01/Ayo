    ...
    async def liquider(self, inter: disnake.Interaction, member: disnake.User) -> None:
        ...
        match(member.id):
            ...
            case inter.author.id:
                message = f"{inter.author.mention} vient de se liquider à l'aide d'{weapon} !"
            case _:
        ...
        await inter.send(embed = disnake.Embed(
            ...
            .set_footer(text = f"L'image ne se charge pas ? Contactez le support pour résoudre ce problème.\nCID: {cid}")
        )
